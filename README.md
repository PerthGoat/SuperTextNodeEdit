...
text copy and paste. Copies also include standard RTF and HTML links so the
hyperlinks remain clickable when pasted into compatible document software.
Right-click a hyperlink to copy its destination or edit the link.
